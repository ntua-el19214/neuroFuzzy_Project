function [x_dot, aux]= nonLinearVehicleModel(t, Y, deltaValues, vehicle, ssVectorSA, fxSS ,ExpandedMatrices, mode,ratio,rampRate)
...
aux.psiDDotError = psi_ddot_err;
aux.psi_ddot     = psi_ddot;
aux.ay           = ay;
aux.ax           = ax;
end
